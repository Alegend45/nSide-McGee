...
void PPU::write(uint16 addr, uint8 data) {
  ...
  case 6:  //PPUADDR
    ...
    return;
  case 7:  //PPUDATA
    if(raster_enable() && (status.ly <= 240 || status.ly == (system.region == System::Region::NTSC ? 261 : 311))) return;
...
const uint9_t PPU::RP2C04_1[16 * 4] = {
...
const uint9_t PPU::RP2C04_2[16 * 4] = {
...
const uint9_t PPU::RP2C04_3[16 * 4] = {
...
const uint9_t PPU::RP2C04_4[16 * 4] = {
